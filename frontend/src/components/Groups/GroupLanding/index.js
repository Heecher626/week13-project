...
export function GroupLanding() {
  ...
  return (
    <div className="group-landing-container">
      <div className="links">
        <span>
          <NavLink to="/events" className="events-link">
            Events
          </NavLink>
          {"   "}
          <span>Groups</span>
      ...
      <div className="group-box">
        {Object.entries(groups).map((element) => {
          ...
          if (element[1].GroupImages) {
            ...
            preview =
              element[1].previewImage == "No preview image"
                ? "https://t3.ftcdn.net/jpg/02/48/42/64/360_F_248426448_NVKLywWqArG2ADUxDq6QprtIzsF82dMF.jpg"
                : element[1].previewImage;
          }
          return (
            <div key={element[1].id} className="group">
              <NavLink to={`/groups/${element[1].id}`}>
                ...
                <div>
                  ...
                  <h3>
                    {element[1].city}, {element[1].state}
                  </h3>
                  <p>{element[1].about}</p>
                  <h3>
                    {element[1].numEvents} Event
                    {element[1].numEvents == 1 ? "" : "s"} ·{" "}
                    {element[1].private ? "Private" : "Public"}
                  </h3>
                </div>
              </NavLink>
            </div>
